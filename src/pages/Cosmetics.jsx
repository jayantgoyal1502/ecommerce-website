...
export default function Cosmetics() {
    ...
    fetch("http://192.168.1.33:5050/api/products")
      ...
      .then((data) => {
        const cosmetics = data.filter((item) => {
          ...
          return t.includes("cosmetic") || t.includes("lipstick") || t.includes("makeup") || t.includes("eye shadow");
        });
        setProducts(cosmetics);
        setCategories(["All", ...Array.from(new Set(cosmetics.map((p) => p.type)))]);
      });
  }, [msg]);
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-semibold mb-4">Cosmetics Collection</h1>
